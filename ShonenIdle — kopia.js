...
function updateEfficiency()
{
	...
	var bestAttack = bestEfficiency[0];
	var con = true;
	while (con)
	{
		skillsUpdate();
		//alert(bestEfficiency[0])
		//alert(skillsInfo[bestEfficiency[0]].level)
		for (var i = 0; i < attackList.length; i++) 
		{
			if (skillsInfo[bestEfficiency[0]].efficiency > skillsInfo[attackList[i]].efficiency) //  && attackList[i] != bestEfficiency[0]
			{
		...
		//if ((skillsInfo[bestEfficiencyUpgrade[0][0]].upgrades[bestEfficiencyUpgrade[0][1]].efficiency < skillsInfo[bestEfficiency[0]].efficiency) && ((con || bestEfficiencyUpgrade[0][0] == bestEfficiency[0])))
		if ((skillsInfo[bestEfficiencyUpgrade[0][0]].upgrades[bestEfficiencyUpgrade[0][1]].efficiency < skillsInfo[bestEfficiency[0]].efficiency) && ((con || bestEfficiencyUpgrade[0][0] == bestEfficiency[0])))
		{
